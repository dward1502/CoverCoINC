		...
		<footer className={styles.footer}>
			<div className={styles.container}>
				<div className={styles.logo}>
					<Image alt="CoverCoInc" src={LOGO} fill className={styles.custom_img} />
				</div>
				...
				<div className={styles.newsLetter}>
					...
					<form id="newsletter" className={styles.form}>
						<input type="email" name="newsletter" id="email" placeholder="Your E-Mail" />
				...
				<div className={styles.socialIcons}>
					...
					<a href="https://www.facebook.com/Coverco-Inc-106844079375679/" rel="noreferrer" target="_blank">
						<i>
							<FaFacebook />
						</i>
					</a>
